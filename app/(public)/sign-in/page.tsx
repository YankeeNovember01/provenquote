      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0F1729] border border-white/[0.08] rounded-2xl p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-white/10 rounded-lg px-4 py-3 text-white hover:bg-white/5 transition font-medium text-sm mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-slate-500"><span className="bg-[#0F1729] px-3">or sign in with email</span></div>
          </div>
